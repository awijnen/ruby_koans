...
class AboutMethods < EdgeCase::Koan
  ...
  private :my_private_method # this statement alters the visibility (i.e privacy) of the my_private_method (http://en.wikibooks.org/wiki/Ruby_Programming/Syntax/Classes#Private)
